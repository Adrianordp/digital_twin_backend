...
This module serves as the main entry point for the FastAPI application that provides
a digital twin simulation and control API. It includes endpoints for simulating
physical systems, controlling their states, and monitoring their behavior.
